...
According to the [Agricultural Waste Managemnet Field Handbook](https://directives.sc.egov.usda.gov/viewerFS.aspx?hid=21430), a cow can produce between
[`85` and `133` pounds of waste per day](https://directives.sc.egov.usda.gov/OpenNonWebContent.aspx?content=31475.wba). This equates to `4.4` to `6.9` kg
of methane gas production per day. A kilogram of methane gas contains approximately
